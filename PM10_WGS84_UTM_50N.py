...
input_path = r"I:/nc_task/3_air-related/PM10_13-20_WGS84_daily/"
output_path = r"I:/nc_task/3_air-related/PM10_13-20_WGS84_UTM_50N_daily/"

for raster in os.listdir(input_path):

    file_input = input_path + raster
    file_output = output_path + 'PM10' + file_input.split('PM10')[2].split('.')[0] + '_UTM_50N.tif'
    pro_raster = wgs84_UTM(aim_path=file_input, out_path=file_output, UTM_Zone=50, pixel_spacing=1000)