...
if __name__ == "__main__":
    ...
    raster_path = 'I:/nc_task/2_soil-related/SMCI_13-20_WGS84_UTM_50N_yearly/mean/'
    zones_path = 'I:/nc_task/shp/spatial_join_5km/'
    csv_path = 'I:/nc_task/2_soil-related/SMCI_13-20_WGS84_UTM_50N_yearly_zonal_csv/'
    ...
    for i in range(0, len(fn_raster)):
        fn_csv = csv_path + str(2013 + i) + '_zonal_statistics_5km_SMCI_mean.csv'
