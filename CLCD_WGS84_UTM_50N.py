...
input_path = r"I:/nc_task/4_biology-related/CLCD_13-20_WGS84_yearly/"
output_path = r"I:/nc_task/4_biology-related/CLCD_13-20_WGS84_UTM_50N_yearly/"

for raster in os.listdir(input_path):
    print(raster)
    file_input = input_path + raster
    file_output = output_path + raster.split('.')[0] + '_UTM_50N.tif'
    pro_raster = wgs84_UTM(aim_path=file_input, out_path=file_output, UTM_Zone=50, pixel_spacing=30)