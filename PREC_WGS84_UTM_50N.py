...
input_path = r"I:/nc_task/1_water-related/PREC_13-20_WGS84_monthly/"
output_path = r"I:/nc_task/1_water-related/PREC_13-20_WGS84_UTM_50N_monthly/"

for raster in os.listdir(input_path):

    file_input = input_path + raster
    file_output = output_path + 'PREC' + file_input.split('PREC')[2].split('.')[0] + '_UTM_50N.tif'
    pro_raster = wgs84_UTM(aim_path=file_input, out_path=file_output, UTM_Zone=50, pixel_spacing=1000)