...
if __name__ == "__main__":
    ...
    raster_path = 'I:/nc_task/4_biology-related/RTSIF_13-20_WGS84_UTM_50N_yearly/mean/'
    zones_path = 'I:/nc_task/shp/spatial_join_5km/'
    csv_path = 'I:/nc_task/4_biology-related/RTSIF_13-20_WGS84_UTM_50N_yearly_zonal_csv/'

    fn_raster = [raster for raster in os.listdir(raster_path) if raster.endswith('_100m.tif')]
    fn_zones = [shp for shp in os.listdir(zones_path) if shp.endswith('.shp')]

    for i in range(0, len(fn_raster)):
        fn_csv = csv_path + str(2013 + i) + '_zonal_statistics_5km_RTSIF_mean.csv'
